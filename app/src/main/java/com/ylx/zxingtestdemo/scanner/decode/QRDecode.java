package com.ylx.zxingtestdemo.scanner.decode;
...
import com.ylx.zxingtestdemo.scanner.OnScannerCompletionListener;
...
/**
 * 仅仅支持识别二维码的的时候可以将formats.add(BarcodeFormat.QR_CODE);隐藏
 */
