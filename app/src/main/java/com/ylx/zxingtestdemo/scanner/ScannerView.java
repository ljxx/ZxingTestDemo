package com.ylx.zxingtestdemo.scanner;
...
import com.ylx.zxingtestdemo.scanner.camera.CameraManager;
import com.ylx.zxingtestdemo.scanner.common.Scanner;
import com.ylx.zxingtestdemo.scanner.decode.DecodeFormatManager;
...
//    private static final String TAG = ScannerView.class.getSimpleName();
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        //默认解码二维
//        setScanMode(Scanner.ScanMode.QR_CODE_MODE); //扫描二维码
        setScanMode(Scanner.ScanMode.PRODUCT_MODE); //扫描条形码
//        setScanMode(Scanner.ScanMode.DATA_MATRIX_MODE);
